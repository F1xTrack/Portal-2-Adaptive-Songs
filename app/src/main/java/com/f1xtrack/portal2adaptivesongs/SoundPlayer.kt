...
class SoundPlayer(private val context: Context) {
    ...
    fun playBoth(trackName: String, isUserTrack: Boolean) {
        ...
        try {
            val useLong = isLongVersionEnabled(trackName, "normal") && isLongVersionEnabled(trackName, "superspeed")
            ...
            startManualLoop(mediaPlayer, false)
            startManualLoop(mediaPlayerAlt, true)
        } catch (e: IOException) {
